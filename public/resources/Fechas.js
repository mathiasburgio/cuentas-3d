class Fechas{
    ...
    getWeekNumber(date) {
        ...
        // Establecemos la fecha al primer día del año
        d.setHours(0, 0, 0, 0);
        d.setDate(d.getDate() + 4 - (d.getDay() || 7)); // Ajustamos al jueves de esta semana
        const yearStart = new Date(d.getFullYear(), 0, 1); // Primer día del año
